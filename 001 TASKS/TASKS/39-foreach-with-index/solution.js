...
// Производим ДЕСТРУКТУРИЗАЦИЮ объекта в параметры
...
ВАЖНО!!! Можно использовать передачу переметров функции 
в виде объекта, чтобы не заморачиваться с порядком операторов
